...
COMPILE_FLAGS="-O2 -msimd128 -flto -flto=thin -mrelaxed-simd -ffast-math -fno-exceptions -fno-rtti -funroll-loops -mbulk-memory -lomp -pthread"
...
-flto -flto=thin -fwasm-exceptions -matomics -mbulk-memory -lomp -pthread"
