...
COMPILE_FLAGS="-O2 -msimd128 -flto -ftlo=thin -mrelaxed-simd -ffast-math -fno-exceptions -fno-rtti -funroll-loops -mbulk-memory -lomp -pthread"
...
-flto -ftlo=thin -fwasm-exceptions -matomics -mbulk-memory -lomp -pthread"
