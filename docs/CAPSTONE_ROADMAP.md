...
| **Mid** | **Part II door**: a new major biome layer (e.g. *Subterranean Sugar Caves* or *Festival Night Market*) unlocked by discovery / awakened progress |
...
| Option | Pitch | Fit |
|--------|-------|-----|
| **1 — Subterranean Sugar Caves** *(recommended)* | Descent under lake; crystal ribs; muffled tracker / generative reverb; new `music-bindings` biome; god-rays from fissures | Vertical continuity after Sky Islands (up → down) |
