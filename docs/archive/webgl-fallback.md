...
> [!CAUTION]
> **Archived — this document does not describe current behaviour.**
>
> WebGPU is required to enter the world, and none of the toggles, helpers, CI commands, or parity
> notes below work. The live contract is [`docs/webgl-fallback.md`](../webgl-fallback.md) and
> [`docs/WEBGPU_CONTEXT.md`](../WEBGPU_CONTEXT.md#webgl-not-available). Kept only as a design
> reference for a future restore.
