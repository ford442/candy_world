...
import { foliageMaterials, registerReactiveMaterial, attachReactivity, pickAnimation, createClayMaterial, sharedGeometries } from './common.js';
...
export function createTremoloTulip(options = {}) {
    ...
    // Shared geometry: SphereLow (Vortex)
