...
/**
 * Extended Emscripten module with bootstrap functions
 */
interface ExtendedEmscriptenModule extends EmscriptenModule {
    _startBootstrapInit?: () => void;
    _getBootstrapProgress?: () => number;
    _isBootstrapComplete?: () => number;
    _resetBootstrap?: () => void;
    _getBootstrapHeight?: (x: number, z: number) => number;
}
 ...
 * @param emscriptenInstance - The loaded Emscripten module
 * @param onProgress - Callback for progress updates (progress: number)
 * @param onComplete - Callback when bootstrap completes
 * @param pollInterval - Polling interval in ms (default: 50ms)
 * @returns Stop function to cancel polling
 */
export function pollBootstrapProgress(
    emscriptenInstance: EmscriptenModule | null, 
 ...
 * @param emscriptenInstance - The loaded Emscripten module
 * @returns Promise that resolves when bootstrap completes
 */
