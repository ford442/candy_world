...
export function initInput(
    ...
    // @ts-expect-error import.meta.env missing in standard lib
    ...
    if (toggleExploreBtn) {
        toggleExploreBtn.addEventListener('click', (e) => {
            ...
            toggleExploreBtn.setAttribute('aria-label', active ? 'Toggle First-person camera mode' : 'Toggle Explore camera mode');
            toggleExploreBtn.title = active ? 'Return to first-person view (Tab)' : 'Cinematic orbit camera (hold Tab)';
