...
export class WasmParticleSystem {
    ...
    async initWasm() {
        try {
            ...
            // 4. Debug Exports (Check your console to see what is actually there!)
            console.log("✅ WASM Loaded. Exports:", Object.keys(this.wasm));

            // 5. Smart Function Detection (Handles both _underscore and plain names)
            ...
            if (!this.updateFn) {
                ...
                console.warn("Did you use extern \"C\" in your C++ file? Or did you forget -s EXPORTED_FUNCTIONS?");
                return; // Stop here to prevent the crash in update()
            }
