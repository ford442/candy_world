...
There is no WebGL renderer. `?renderer=webgl` is ignored and `RENDERER=webgl npm run test` exits 1 by
design — see [docs/webgl-fallback.md](./docs/webgl-fallback.md).
