...
**Status:** ✅ Completed for arpeggio (#1358), mushroom, portamento, and tree batchers — dedicated `emscripten/batcher_instance.cpp` (`batchWriteInstancePose_c`) + `src/utils/wasm-batcher-instance.ts` with TS fallback.
